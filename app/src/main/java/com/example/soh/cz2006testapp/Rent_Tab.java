...
public class Rent_Tab extends Fragment {
    ...
    /**
     * Returns the view for the Rent_Tab fragment to be displayed
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_rent__tab, container, false);

        recommend = (TextView) rootView.findViewById(R.id.text_view_result_TV);
        recommend.setText("It will be better to rent if you can find a rental lower than $" +
        ...
        expandableListDetail = Expandable_List_Data_Pump_Rent.getData();
